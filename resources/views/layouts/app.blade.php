    ...
    <div class="px-4 py-4 border-t border-slate-100">
      <div class="flex items-center gap-3">
        <a href="{{ route('profile') }}"
           class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white text-xs font-semibold flex-shrink-0 hover:bg-blue-700 transition-colors"
           title="Meu Perfil">
        ...
        <form method="POST" action="{{ route('logout') }}" class="flex-shrink-0">
          @csrf
          <button type="submit" title="Sair" class="text-slate-400 hover:text-red-500 transition-colors">
